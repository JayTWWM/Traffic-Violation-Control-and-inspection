...
public class AdminSearch extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new ListAdapter(AdminSearch.this, R.layout.list_item, threadMap, threadNames, threadTime, threadLink);

        final ListView mThreadListView = findViewById(R.id.EventList);
        mThreadListView.setAdapter(arrayAdapter);

        inputSearch = findViewById(R.id.searchEdit);
        ...
        mThreadListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                Intent intent = new Intent(AdminSearch.this, EventInfo.class);
        ...
        db.collection("Events").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                {
                    Toast.makeText(AdminSearch.this, "Failed to load list.", Toast.LENGTH_LONG).show();
                }
