...
public class ViewApprovals extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_approvals);
        CheckPermission();
        ...
        db.collection("Approved").document(docId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ViewApprovals.this, e.toString(), Toast.LENGTH_LONG).show();
                    }
                })
    ...
    public void onProviderDisabled(String provider) {
        Toast.makeText(ViewApprovals.this, "Please Enable GPS and Internet", Toast.LENGTH_SHORT).show();
    }
